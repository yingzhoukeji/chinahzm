...
drawLinks();});};
/*getSortData*/
(function(){$.getJSONP("",getBrandService);})();function getBrandService(json){var data=json.data;$.each(data,function(i){var html="<dl class=\"brands\"><dt>推荐品牌</dt><dd>";var d1=data[i]["b"],d2=data[i]["p"];if (d1.length>0){$.each(d1,function(j){html+="<em><a href=\""+ d1[j]["u"] +"\">"+ d1[j]["n"] +"</a></em>";});}else{html+="<div class='norecode'>暂无推荐品牌！</div>";}html+="</dd></dl><dl class=\"promotion\"><dt>促销活动</dt><dd><ul>";if (d2.length>0){$.each(d2,function(k){html+="<li>·<a href=\""+ d2[k]["u"] +"\">"+ d2[k]["n"] +"</a></li>";});}else{html+="<div class='norecode'>暂无促销活动！</div>";}html+="</ul></dd></dl>";$("#JD_sort_"+data[i]["id"]).html(html);});}
/*jdThickbox*/
