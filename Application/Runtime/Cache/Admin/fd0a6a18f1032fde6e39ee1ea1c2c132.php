...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='微信活动管理 > 编辑活动'; ?>
                ...
                <div id="Right">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
							...
							<tr>
                                <th>结束日期：</th>
                                <td><input id="title" type="text" class="input" size="60" name="endtime" value='<?php echo (date("Y-m-d",$info["endtime"])); ?>' onClick="WdatePicker()"/></td>
                            </tr>
							<tr>
                                <th>活动积分：</th>
                                <td><input id="title" type="text" class="input" size="60" name="srcoe" value="<?php echo ($info["srcoe"]); ?>"/></td>
                            </tr>
							<tr>
                                <th>兑换礼品最低积分：</th>
                            ...
                            <tr>
                                <th>活动图片：</th>
                                <td><input type="text" id="url1" class="input" size="40" name="image" value="<?php echo ($info["image"]); ?>"/>
