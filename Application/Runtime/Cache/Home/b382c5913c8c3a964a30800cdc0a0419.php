...
<div class="body">
  <article class="destination">
    <header class="destination__header content-fill"> <img data-src="/documents/news-banner.jpg" data-image="/documents/news-banner.jpg" data-image-dimensions="1000x400" data-image-focal-point="0.5,0.5" alt="news-banner.jpg" >
      <div class="destination__meta">
		<p></p>
        <p><strong><?php echo ($name); ?></strong><em>Delicious first, health based</em></p>
      </div>
	  ...
	  <div class="subnav">
      <ul>
		<?php if(is_array($list1)): foreach($list1 as $key=>$vo): if($vo['cid'] == $where['cid']): ?><li class="subnav__item  subnav__item--active"> <a href="/index.php/news/index/cid/<?php echo ($vo["cid"]); ?>"> <span class="iconfont cid<?php echo ($vo["cid"]); ?>"></span> <span><?php echo ($vo["name"]); ?></span> </a> </li> 
			<?php else: ?> <li class="subnav__item "> <a href="/index.php/news/index/cid/<?php echo ($vo["cid"]); ?>"> <span class="iconfont cid<?php echo ($vo["cid"]); ?>"></span> <span><?php echo ($vo["name"]); ?></span> </a> </li><?php endif; endforeach; endif; ?>       
      </ul>
    </div>
	
    <main id="content" class="content destination__content" role="main" data-content-field="main-content">
      <h1 class="destination__title"><?php echo ($name); ?></h1>
      <div class="blog">        
        ...
        <div class="sqs-layout sqs-grid-12 columns-12 blog-index">
          <div class="row sqs-row">
            <div class="col sqs-col-9 span-9"> 
              ...
              <!--ITEM LOOP-->
			  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row sqs-row">
                      ...
                      <div class="image-block-outer-wrapper layout-caption-below ">
                        <div class="intrinsic" style="max-width:960.0px;">
                          <div style="padding-bottom:62.5%;" class="image-block-wrapper has-aspect-ratio"> 
                            ...
                            <a href="<?php echo U('news/read',array('id'=>$vo['id']));?>" class="main-image"> <img src="<?php echo get_default_img($vo['image_id']);?>"/> </a> </div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col sqs-col-6 span-6">
                  <div class="sqs-block html-block sqs-block-html">
                    <div class="sqs-block-content"> 
                      ...
                      <h2 class="blog-index__title mxftitle" data-content-field="title"> <a href="<?php echo U('news/read',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a> </h2>
                      ...
                      <p><?php echo cutStr($vo['summary'],130,0);?></p>
                      <p class="mxfmore"> <a href="<?php echo U('news/read',array('id'=>$vo['id']));?>">更多</a> </p>
                    </div>
                  </div>
                </div>
              </div>
			  ...
			  <div class="mxfpage"> <?php echo ($page); ?> </div>
            </div>
      ...
      <p class="back-to-top"> <a href="#"><img src="/documents/top.png" title="返回顶部"></a> </p>
    </main>
  </article>
