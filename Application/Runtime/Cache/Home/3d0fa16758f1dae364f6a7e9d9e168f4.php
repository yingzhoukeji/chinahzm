...
<link href='/documents/iconfont.css' rel='stylesheet' type='text/css'>
<link rel="stylesheet" type="text/css" href="/documents/shopcart/style.css"/>	
<meta charset="utf-8" />
...
<script>(function(rollups, name) { if (!rollups[name]) { rollups[name] = {}; } rollups[name].js = ["/documents/common-207d2bd6db5e20beb67a-min.js"]; })(SQUARESPACE_ROLLUPS, 'squarespace-common');</script>
...
<script>Static.SQUARESPACE_CONTEXT = {"facebookAppId":"314192535267336","rollups":{"squarespace-audio-player":{"css":"/documents/audio-player-76e4bfcc3f9830beb388bae2002fbe6c-min.css","js":"/documents/audio-player-929d3b33571948f9b96a-min.js"},"squarespace-blog-collection-list":{"css":"/documents/blog-collection-list-d41d8cd98f00b204e9800998ecf8427e-min.css","js":"/documents/blog-collection-list-59685cbdbd28694cf2f5-min.js"},"squarespace-calendar-block-renderer":{"css":"/documents/calendar-block-renderer-0081bda8bafd2e574bfc05218b33687d-min.css","js":"/documents/calendar-block-renderer-490334e1305595b6fd27-min.js"},"squarespace-chartjs-helpers":{"css":"/documents/chartjs-helpers-9935a41d63cf08ca108505d288c1712e-min.css","js":"/documents/chartjs-helpers-e102da2bd14a85676246-min.js"},"squarespace-comments":{"css":"/documents/comments-56d2708d36aa119f08d126978a305f0f-min.css","js":"/documents/comments-ef8ae5ba607836d0d526-min.js"},"squarespace-dialog":{"css":"/documents/dialog-be200ed7f5c57483743a18984283b649-min.css","js":"/documents/dialog-19b5771e738244202d65-min.js"},"squarespace-events-collection":{"css":"/documents/events-collection-0081bda8bafd2e574bfc05218b33687d-min.css","js":"/documents/events-collection-6578036d64c203e49d16-min.js"},"squarespace-image-zoom":{"css":"/documents/image-zoom-ae974921915aeccaff8ad60c60e19c31-min.css","js":"/documents/image-zoom-980ef1fef5c43e326d9a-min.js"},"squarespace-pinterest":{"css":"/documents/pinterest-d41d8cd98f00b204e9800998ecf8427e-min.css","js":"/documents/pinterest-bdd2acdd896f781d1e31-min.js"},"squarespace-product-quick-view":{"css":"/documents/product-quick-view-bb658543b4283f335502f712d3cf5696-min.css","js":"/documents/product-quick-view-c2e41d28e81f4b9dbeeb-min.js"},"squarespace-products-collection-item-v2":{"css":"/documents/products-collection-item-v2-ae974921915aeccaff8ad60c60e19c31-min.css","js":"/documents/products-collection-item-v2-2ba24d04eb2efb9d2e7f-min.js"},"squarespace-products-collection-list-v2":{"css":"/documents/products-collection-list-v2-ae974921915aeccaff8ad60c60e19c31-min.css","js":"/documents/products-collection-list-v2-2d23f141cb98959389ea-min.js"},"squarespace-search-page":{"css":"/documents/search-page-feb7768f9a9907b47ac689b118f3db8e-min.css","js":"/documents/search-page-b4bdfc12ffc74dceb7f7-min.js"},"squarespace-share-buttons":{"js":"/documents/share-buttons-a7478b3676a91793bde6-min.js"},"squarespace-simple-liking":{"css":"/documents/simple-liking-09fa291ec2800c97714f0d157fd0a6ca-min.css","js":"/documents/simple-liking-391652528355d616ce10-min.js"},"squarespace-social-buttons":{"css":"/documents/social-buttons-578fb344ac92d6ab44d6030c1b952622-min.css","js":"/documents/social-buttons-e887955e9d346497b0b5-min.js"},"squarespace-tourdates":{"css":"/documents/tourdates-b5e2052fe27121e052bbe8ad40ba5c3e-min.css","js":"/documents/tourdates-3d34d41c62a8c551cae3-min.js"}},"pageType":2,"website":{"id":"54358a2de4b0d108c674157c","identifier":"inca1","websiteType":1,"contentModifiedOn":1451952132293,"cloneable":false,"developerMode":true,"location":{}}}; SquarespaceFonts.loadViaContext(); Squarespace.load(window); </script>
...
<div class="body cpread">
  <article class="destination">
    <header class="destination__header content-fill"> <img data-src="/documents/origins-trip-banner.jpg" data-image="/documents/origins-trip-banner.jpg" data-image-dimensions="1200x400" data-image-focal-point="0.5,0.5" alt="origins-trip-banner.jpg" >
      <div class="destination__meta">
		<p></p>
        <p><strong><?php echo ($info['cname']); ?></strong><em>Delicious first, health based</em></p>
      </div>
    </header>
    <div class="subnav">
      <ul>
		<?php if(is_array($list1)): foreach($list1 as $key=>$vo): if($vo['cid'] == $info['cid']): ?><li class="subnav__item  subnav__item--active"> <a href="/index.php/product/index/cid/<?php echo ($vo["cid"]); ?>"> <span class="iconfont cid<?php echo ($vo["cid"]); ?>"></span> <span><?php echo ($vo["name"]); ?></span> </a> </li> 
			<?php else: ?> <li class="subnav__item "> <a href="/index.php/product/index/cid/<?php echo ($vo["cid"]); ?>"> <span class="iconfont cid<?php echo ($vo["cid"]); ?>"></span> <span><?php echo ($vo["name"]); ?></span> </a> </li><?php endif; endforeach; endif; ?>    
      </ul>
    </div>
    <main id="content" class="content destination__content" role="main" data-content-field="main-content">
      <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1450378386496" id="page-54524798e4b009dd79110b00">
        <div class="row sqs-row">
              <div class="col sqs-col-5 span-5">
				<div class="sqs-block image-block sqs-block-image" data-aspect-ratio="100" data-block-type="5" id="block-789061d9c79d6665a700">
                  <div class="sqs-block-content">
                    <div class="image-block-outer-wrapper layout-caption-below ">
                      <div class="intrinsic" style="max-width:100%;">
                        <div class="mxftp">
							<img id="goodsimg" src="<?php echo get_default_img($info['image_id']);?>"/>
							<ul>						
							<?php if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo['savepath']); ?>" onMouseOver="showPic(this); return false;" onclick="showPic(this); return false;"><img src="<?php echo ($vo['savepath']); ?>" border=0/></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
                      </div>
                    </div>
              ...
              <div class="col sqs-col-5 span-5">
                ...
                <div class="sqs-block html-block sqs-block-html" data-block-type="2" id="block-yui_3_17_2_1_1413481153166_66876">
                  <div class="cpprice">
                    <h2><span>价格：</span><span><?php echo (L("T_F")); echo ($info["price"]); ?></span><span> / <?php echo ($info["unit"]); ?></span></h2>
                  </div>
                </div>
				<p class="mxfbt">
					<span><a class="buy" href="/index.php/Order/orderinfo">立即购买</a></span>
					<span><a class="addcar"><i class="iconfont icon-gouwuche"></i>加入购物车</a></span>
				</p>
                <div class="sqs-block horizontalrule-block sqs-block-horizontalrule" data-block-type="47" id="block-yui_3_17_2_1_1413481153166_72480">
                  <div class="sqs-block-content">
                    <hr />
                  </div>
                </div>
			  ...
			  <div class="col sqs-col-2 span-2">
			    <div class="shophelp">
				  <a href="/index.php/page/index/name/lpqsm"> 
					<span><p class="zw">礼品券说明</p><p class="yw">Gift certificate explain</p></span>
					<span><img src="/documents/lpq.jpg"></span>
				  </a>
				</div>
				<div class="shophelp">
				  <a href="/index.php/page/index/name/gwlc"> 
					<span><p class="zw">购物流程</p><p class="yw">Shopping process</p></span>
					<span><img src="/documents/gwlc.jpg"></span>
				  </a>
				</div>
				<div class="shophelp">
				  <a href="/index.php/page/index/name/pszc"> 
					<span><p class="zw">配送政策</p><p class="yw">Distribution policy</p></span>
					<span><img src="/documents/pszc.jpg"></span>
				  </a>
				</div>
				<div class="shophelp">
				  <a href="/index.php/page/index/name/zxzf"> 
					<span><p class="zw">在线支付</p><p class="yw">Online payment</p></span>
					<span><img src="/documents/zxzf.jpg"></span>
				  </a>
				</div>
				<div class="shophelp">
				  <a href="/index.php/page/index/name/hdfk"> 
					<span><p class="zw">货到付款</p><p class="yw">Cash on delivery</p></span>
					<span><img src="/documents/hdfk.jpg"></span>
				  </a>
				</div>
				<div class="shophelp">
				  <a href="/index.php/page/index/name/shfw"> 
					<span><p class="zw">售后服务</p><p class="yw">After-sales service</p></span>
					<span><img src="/documents/shfw.jpg"></span>
				  </a>
				</div>
			  </div>
        </div>
		...
		<div class="row sqs-row">
			<div class="col sqs-col-10 span-10">
				<div class="sqs-block html-block sqs-block-html" data-block-type="2" id="block-9ae54d6e03de1eb5d6a9">
                  <div class="sqs-block-content">
				    <div>
						<h2 class="cpxq">产品详情</h2>
						<p><?php echo ($info['content']); ?></p>
					</div>					
					<div>
					   <h2 class="ykly">游客留言</h2>
					   <div class="message">
						 <?php if(is_array($lylist)): $i = 0; $__LIST__ = array_slice($lylist,1,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
							<dt><?php echo ($vo["username"]); ?>：</dt>
							<dd><?php echo ($vo["content"]); ?></dd>
							<dd><?php echo date('Y年m月d日',$vo['addtime']);?></dd>
...
<!--购物车-->
<div class="m-sidebar">
	<a class="qq" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($site["qq"]); ?>&site=qq&menu=yes"></a>
	<div class="cart">		
		<i id="end"></i>
		<span>购物车</span>
	</div>
	<div class="lyhzd">
		<a href="/index.php/message/index" class="liuyan"></a>
		<p class="back-to-top"> <a href="#" class="zhiding"></a> </p>
	</div>
</div>
<div id="qqzx">Q Q 咨询</div>
<div id="khfk">客户反馈</div>
<div id="fhdb">返回顶部</div>
...
<script>
	function showPic(whichpic)
	{
		...
		var placeholder = document.getElementById("goodsimg");
		placeholder.setAttribute("src",source);
	}
</script>

<!--购物车--> 
<script src="/img/jquery-1.11.0.min.js" type=text/javascript></script>
<script src="/img/jquery.cookie.js"></script>
<script type="text/javascript" src="/img/livere8_lib.js" charset="utf-8"></script>
<script type="text/javascript" src="/img/shopcart/jquery.fly.min.js" charset="utf-8"></script>
...
<script>
	jQuery( document ).ready(function($) {
		...
		$(".addcar").click(function(event){
			...
			$.post("<?php echo U('Order/addshopcart');?>",{goodid:goodid},function(json){
				setTimeout(function(){
		    		 layer.close(index);
		    		 if(json.status==0){
		    			...
		    			layer.confirm('未登录，是否登录？', {
	    				    ...
	    				    window.location.href="<?php echo U('Member/index').'?goto='.urlencode(get_url()); ?>";
	    				}, function(){
	  ...
	  $(".cart").click(function(){
		  window.location.href="<?php echo U('Order/mycart');?>";
	  });
	});
</script>
