...
<h1 class="destination__title"><?php echo ($info['cname']); ?></h1>
<div class="blog-article">
  <div class="sqs-layout sqs-grid-12 columns-12">
    <div class="row sqs-row">
      <div class="col sqs-col-12 span-12"> 
        ...
        <article id="post-566ef2f64bf1180dabba9db3" class="hentry author-alan-abonyi post-type-text" data-item-id="566ef2f64bf1180dabba9db3"> 
          
          <!--POST TILE-->
          
		  <div class="mxfxw">
			  <h2 class="blog-article__title" data-content-field="title"><?php echo ($info['title']); ?></h2>
			  <p>
				<span>发布时间：<?php echo date('Y-m-d',$info['published']);?></span>
				<span>浏览量：<?php echo ($info['click']); ?></span>
			  </p>
		  </div>
          
          <!--MAIN CONTENT-->
          
          <div class="sqs-layout sqs-grid-12 columns-12" data-layout-label="Post Body" data-type="item" data-updated-on="1450130042357" id="item-566ef2f64bf1180dabba9db3">
            <div class="row sqs-row">
              <div class="col sqs-col-9 span-9">
                <div class="mxfxwnr"><?php echo ($info['content']); ?>
				<p class="return"><a href="/index.php/news/index/cid/<?php echo ($info['cid']); ?>">返回列表</a></p>
				</div>
              </div>
  ...
  <div class="pagination-large">
    <div class="sqs-gallery-controls show-hover-effect"> <?php echo ($page); ?> </div>
  </div>
