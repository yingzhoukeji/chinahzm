  ...
  <article class="destination">
    <header class="destination__header content-fill"> <img data-src="/documents/our-story-banner.png" data-image="/documents/our-story-banner.png" data-image-dimensions="1500x999" data-image-focal-point="0.48138297872340424,0.30677290836653387" alt="our-story-banner.png" >
      <div class="destination__meta">
		<p></p>
        <p><strong><?php echo ($info["page_name"]); ?></strong><em>Delicious first, health based</em></p>
      </div>
      <button class="back-button">返回</button>
      <a href="#" class="destination-button"></a> </header>
    <div class="subnav">
      <ul>
		<?php if(is_array($list)): foreach($list as $key=>$vo): if($vo['guide'] == $info['id']): ?><li class="subnav__item  subnav__item--active"> <a href="<?php echo ($vo["link"]); ?>"> <span class="iconfont nav<?php echo ($vo["id"]); ?>"></span> <span><?php echo ($vo["nav_name"]); ?></span> </a> </li> 
			<?php else: ?> <li class="subnav__item "> <a href="<?php echo ($vo["link"]); ?>"> <span class="iconfont nav<?php echo ($vo["id"]); ?>"></span> <span><?php echo ($vo["nav_name"]); ?></span> </a> </li><?php endif; endforeach; endif; ?>       
      </ul>
    </div>
    <main id="content" class="content destination__content" role="main" data-content-field="main-content">
      <h1 class="destination__title"><?php echo ($info["page_name"]); ?></h1>
