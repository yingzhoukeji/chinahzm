...
<link rel="stylesheet" type="text/css" href="/documents/member.css"/>
<meta charset="utf-8" />
<title>会员登入-<?php echo ($site["name"]); ?></title>
...
<div id="container" class="container">
	<div class="content">
		<h2>会员登入</h2>
		<div class="subCont">
			<form action="<?php echo U('Member/login');?>" id="loginForm" method="post">
				<ul class="box">
					<li>
						<fieldset class="login" style="display:<?php if(session('uid')!=null){echo 'none';}else{echo 'block';} ?>;">
							<div class="title">请<em>注册登入下单</em></div>
							<div class="idPw">
								<div class="inputMask">
									<input placeholder="输入手机号码" type="text" id="telephone" name="telephone" value="" title="用户名" style="ime-mode:disabled;" onkeyup="cfn_enterEvent(event,'loginCheck()');" >
								</div>
								<div class="inputMask">
									
									<input placeholder="输入密码"  type="password" id="password" name="password" value="" title="密码" onkeyup="cfn_enterEvent(event,'loginCheck()');" >
								</div>
								<div class="loginBtn">
									<button type="button" class="button" onclick="loginCheck()">登入</button>
								</div>
							</div>
							<div class="checkType">
								<input checked='checked' type="checkbox" id="idSave" class="chk" name=""><label for="genderMan">记住密码</label>
							</div>
							<div class="btnArea">
								<a href="/index.php/Member/register">注册会员</a>
								<a href="/">忘记密码</a>
							</div>
						</fieldset>
					</li>
					<li>
						<dl class="member">
							<dt class="title">会员<em>管理中心</em></dt>
							<dd>
								<span class="icoSns facebook"><a href="/index.php/Order/mycart"><em class="blind">购物车</em></a></span>
								<span class="icoSns twitter"><a href="/index.php/Usercenter/index"><em class="blind">会员管理</em></a></span>
								<p>您的满意是我们的努力！</p>
							</dd>
						</dl>
					</li>
...
<script src="/img/ajaxupload.3.5.js"></script>
<script src="/img/exchangeSelect.js"></script>
<script src="/img/common.js"></script>
<script src="/img/kakao.link.js"></script>
<script src="/img/querySelector.polyfill.js"></script>
<script src="/img/jquery.cookie.js"></script>
<script src="/img/jquery.placeholder.js"></script>
<script type="text/javascript" src="/img/jquery.rwdImageMaps.min.js"></script>
...
<script type="text/javascript" src="/img/shopcart/jquery.form.js" charset="utf-8"></script>
<script type="text/javascript">
	...
	function loginCheck(){
		...
		var ischecked=$("#idSave").get(0).checked;
		if(ischecked){
