...
<div class="content"><img src="../../images/FL9.jpg"></div>
  <ul class="mui-table-view" style="margin:0 0 50px 0;">
	 <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('原料来源','ylly')">
								 原料来源
							</a></li>
                            <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('研发团队','yftd')">
								 研发团队
							</a></li>
                            <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('加工团队','jgtd')">
								加工团队
							</a></li>
                            <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('食品安全','spaq')">
								食品安全
							</a></li>
                            <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('保障体系','bztx')">
								保障体系
							</a></li>
                            <li class="mui-table-view-cell"><a class="mui-navigate-right" href="javascript:openDetail('产品认证','cprz')">
								产品认证
							</a></li>
  </ul>
</div>
