...
<div class="mui-content">
		...
		<div id="scroll" class="mui-content mui-scroll-wrapper" style="-webkit-overflow-scrolling:auto;top: 0px;">
			<div id="orderdetail">
				
				<div class="mui-input-group" style=" margin:0 0 70px 0">
	...
	<script>
					...
					if(orderdetail.paytype==1){
							html+='<div class="mui-input-row">';
								...
								if(orderdetail.ispay==1){
									...
									html+='<span>否</span>';
									html+='<span onclick="gopay1('+orderdetail.id+')" class="pay-btn mui-pull-right mui-btn mui-btn-success mui-btn-outlined">马上支付</span>';
								}
							html+='</div>';
					}
		...
		function gopay1(oid){
			var url=BasePath+"/weidian/pay/test/sssssssssssssssssssss.php?oid="+oid;
